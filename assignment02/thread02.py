...
if __name__ == "__main__":
    ...
    chefs = [] # Initialize as a list
    for index in range(2):
        c = threading.Thread(target=cooking, args=(index,)) # Corrected: args should be a tuple
        chefs.append(c)
        c.start()

    for c in chefs: # Corrected: simplified iteration over chefs list
        c.join()
